...
public class RandomTextWriter extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		System.out.println("Job deadline: " + this.getConf().get("deadline"));
	...
	public static void main(String[] args) throws Exception {
		...
		Configuration.addDefaultResource("deadline");
		conf.setLong("deadline", 1L);
		int res = ToolRunner.run(conf, new RandomTextWriter(), args);
		System.exit(res);
	}
